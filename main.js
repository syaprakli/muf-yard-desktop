    ...
    try {
        ...
        if (!fs.existsSync(targetDir)) {
            ...
            if (fs.existsSync(sourceDir)) {
                ...
                console.error('Kaynak şablonlar bulunamadı:', sourceDir);
            }
        }
    } catch (err) {
